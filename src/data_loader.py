...
# 작성일 : 2026-07-21
# 작성목적 : UCI Adult 데이터셋 다운로드 및 Pandas/Polars 로딩·비교
#
# 본파일은 Skala 교육을 위한 Sample 코드이므로 작성자에게 모든 저작권이 있습니다.
#
# 변경사항 내역(날짜, 변경목적, 변경 내용 순으로 기입)
#   - 2026-07-21, Pandas/Polars 결과 불일치 수정, load_with_polars에서 공백 제거 후
#     수치형 컬럼을 Int64로 재캐스팅하고 파일 끝 빈 줄로 생긴 null 행 제거
#   - 2026-07-21, 로딩 결과 검증 강화, compare_pandas_polars에 행 수 일치 assert 추가
#
# ----------------------------------------------------------------------------
